...
const api_1 = `?api_key=${api_key}`;

//Movies APIS
export const Movies_Gernes_API = `${VITE_APP_DOMAIN}genre/movie/list${api_l}`;

export const Movie_Detail_API = (movie_id) =>
  `${VITE_APP_DOMAIN}movie/${movie_id}${api_l}`;

export const Movie_Image_API = (movie_id) =>
  `${VITE_APP_DOMAIN}movie/${movie_id}/images${api_l}`;

export const Movie_Lists_API = (movie_id) =>
  `${VITE_APP_DOMAIN}movie/${movie_id}/lists${api_1}`;
...
export const Get_Videos_API = (movie_id) =>
  `${VITE_APP_DOMAIN}movie/${movie_id}/videos${api_l}`;
...
export const TV_Images_API = (tv_id) =>
  `${VITE_APP_DOMAIN}tv/${tv_id}/images${api_l}`;

export const Similar_TV_Show_API = (tv_id) =>
  `${VITE_APP_DOMAIN}tv/{tv_id}/similar${api_l}`;

export const TV_Videos_API = (tv_id) =>
  `${VITE_APP_DOMAIN}tv/${tv_id}/videos${api_l}`;
