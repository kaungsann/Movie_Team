...
import Tab2 from "../Tab2/TvTab";
// import Recommend from "../Recommend/Recommend";
import { useParams } from "react-router-dom";
import { fetchWithAxios, imgUrl } from "../../services/apiservices.js";
import { TV_Detail_Video_API, TV_Detail_API } from "../../services/Constant.js";
...
const TVDetaile = () => {
  ...
  const f1 = () => {
    fetchWithAxios(TV_Detail_Video_API(id))
      .then((res) => {
